...
# python FACEMESH_VIDEO_LOAD_TEST_V1_LargerDropout.py
# ==================================================================================
...
FACIAL_MODEL_PATH = '..\models\MediaPipe_ImageClassifier_Tanh.onnx'
...
def extract_facial_feature(landmarks, image):
    AU1 = 0
    AU2 = 0
    AU4 = 0
    AU6 = 0
    ...
    AU26 = lerp(AU26,0,1.3)         
    if AU26 > 0.1:
       AU25 = 1
    
    
    # Dlib testing
    #print(dlib_feature.shape)
