...
#dataset_name=['Test']
#dataset_directory=['E:\\Documents\\EmotionDatabases\\Enlarged Video Libraries\\RAVDESS_640_Labelled\\%s\\*.mp3']


# SIMPLE: Oreau   ( 94.0909090909091 %) (files= 440 )    RAVDESS   ( 99.59935897435898 %) (files= 1248 )
# aDVANCED: 
#dataset_name=['Oreau','RAVDESS']
...
print("Load model")
MODEL_PATH = 'AudioClassifier_V2.onnx'
path = MODEL_PATH
...
def predict(row, ort_session):
    ...
    #print(prediction, " ", (100 * ort_outs[0][4]))
    #print(prediction, " ", int(100 * ort_outs[0][0][0]), " ", int(100 * ort_outs[0][0][1])," ", int(100 * ort_outs[0][0][2])," ", int(100 * ort_outs[0][0][3]), " ", int(100 * ort_outs[0][0][4])," ", int(100 * ort_outs[0][0][5])," ", int(100 * ort_outs[0][0][6]))
